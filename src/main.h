...
/* Private defines -----------------------------------------------------------*/
#define BAR_NCS_Pin GPIO_PIN_4
#define BAR_NCS_GPIO_Port GPIOC
#define IMU_NCS_Pin GPIO_PIN_5
...
#define PER_NCS_Pin GPIO_PIN_7
#define PER_NCS_GPIO_Port GPIOE
#define D2_OUT_Pin GPIO_PIN_5
#define D2_OUT_GPIO_Port GPIOG
